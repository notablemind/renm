...
module Version1 = {
  ...
  and deserialize_Data____data:
   ...
   =
    (type arg1, type arg0, contentsTransformer, prefixTransformer, record) =>
      ...
      | JSONObject(dict) =>
        ...
        | Some(json) =>
          switch (
            (deserialize_Belt_MapString____t(deserialize_Data____user))(json)
          ) {
          | Belt.Result.Error(error) =>
  ...
  and deserialize_Sync____changeInner:
   ...
   =
    (type arg1, type arg0, changeTransformer, selectionTransformer, record) =>
      switch (Js.Json.classify(record)) {
      | JSONObject(dict) =>
  ...
  and deserialize_Sync____sessionInfo:
   ...
   =
    (type arg0, selectionTransformer, record) =>
      switch (Js.Json.classify(record)) {
      | JSONObject(dict) =>
        let inner = attr_author => {
