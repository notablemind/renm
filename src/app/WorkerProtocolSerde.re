...
module Types2 = {
  ...
  and migrate_Change____change: Types1._Change__change => _Change__change =
    _input_data =>
      switch (_input_data) {
  ...
  and migrate_Change____data: Types1._Change__data => _Change__data =
    _input_data =>
  ...
  and migrate_Change____rebaseItem:
    Types1._Change__rebaseItem => _Change__rebaseItem =
    _input_data => _input_data
  and migrate_Data____data:
    ...
    (
      ...
      Types1._Data__data('contents, 'prefix)
    ) =>
  ...
  and migrate_Data____date: Types1._Data__date => _Data__date =
    _input_data => _input_data
  and migrate_Data____source: Types1._Data__source => _Data__source =
    _input_data => _input_data
  and migrate_Data____user: Types1._Data__user => _Data__user =
    _input_data => _input_data
  and migrate_Data__Node__id: Types1._Data__Node__id => _Data__Node__id =
    _input_data => _input_data
  and migrate_Data__Node__t:
    ...
    (
      'prefix => 'prefix_migrated,
      'contents => 'contents_migrated,
      Types1._Data__Node__t('contents, 'prefix)
    ) =>
  ...
  and migrate_Data__Tag__id: Types1._Data__Tag__id => _Data__Tag__id =
    _input_data => _input_data
  and migrate_Data__Tag__t: Types1._Data__Tag__t => _Data__Tag__t =
    _input_data => _input_data
  and migrate_Delta____delta: Types1._Delta__delta => _Delta__delta =
    _input_data => _input_data
  and migrate_Js_date____t: Types1._Js_date__t => _Js_date__t =
    _input_data => _input_data
  and migrate_MetaData____remote: Types1._MetaData__remote => _MetaData__remote =
    _input_data => _input_data
  and migrate_MetaData____sync: Types1._MetaData__sync => _MetaData__sync =
    _input_data => _input_data
  and migrate_MetaData____t: Types1._MetaData__t => _MetaData__t =
    _input_data => _input_data
  and migrate_NodeType____prefix: Types1._NodeType__prefix => _NodeType__prefix =
    _input_data => _input_data
  and migrate_NodeType____t: Types1._NodeType__t => _NodeType__t =
    _input_data =>
      migrate_Data__Node__t(
        arg =>
          switch (arg) {
  ...
  and migrate_Session____auth: Types1._Session__auth => _Session__auth =
    _input_data => _input_data
  and migrate_Session____google: Types1._Session__google => _Session__google =
    _input_data => _input_data
  and migrate_StoreInOne__Server__serverFile:
    Types1._StoreInOne__Server__serverFile => _StoreInOne__Server__serverFile =
    _input_data => {
  ...
  and migrate_Sync____change:
    ...
    (
      ...
      Types1._Sync__change('change, 'rebase, 'selection)
    ) =>
  ...
  and migrate_Sync____changeInner:
    ...
    (
      'selection => 'selection_migrated,
      'change => 'change_migrated,
      Types1._Sync__changeInner('change, 'selection)
    ) =>
  ...
  and migrate_Sync____link: Types1._Sync__link => _Sync__link =
    _input_data => _input_data
  and migrate_Sync____sessionInfo:
    'selection 'selection_migrated.
    (
      'selection => 'selection_migrated,
      Types1._Sync__sessionInfo('selection)
    ) =>
  ...
  and migrate_View____cursor: Types1._View__cursor => _View__cursor =
    _input_data => _input_data
  and migrate_View____sharedViewData:
    Types1._View__sharedViewData => _View__sharedViewData =
    _input_data => _input_data
  and migrate_View__Range__range:
    Types1._View__Range__range => _View__Range__range =
    _input_data => _input_data
  and migrate_WorkerProtocol____changeInner:
    Types1._WorkerProtocol__changeInner => _WorkerProtocol__changeInner =
    _input_data =>
      migrate_Sync____changeInner(
  ...
  and migrate_WorkerProtocol____data:
    Types1._WorkerProtocol__data => _WorkerProtocol__data =
    _input_data => migrate_World__MultiChange__data(_input_data)
  and migrate_WorkerProtocol____message:
    Types1._WorkerProtocol__message => _WorkerProtocol__message =
    _input_data =>
      switch (_input_data) {
  ...
  and migrate_WorkerProtocol____serverMessage:
    Types1._WorkerProtocol__serverMessage => _WorkerProtocol__serverMessage =
    _input_data =>
      switch (_input_data) {
      | UserChange(arg0) =>
  ...
  and migrate_World____thisChange:
    Types1._World__thisChange => _World__thisChange =
    _input_data =>
  ...
  and migrate_World__MultiChange__change:
    Types1._World__MultiChange__change => _World__MultiChange__change =
    _input_data =>
      (Belt.List.map(_input_data))(_item => migrate_Change____change(_item))
  and migrate_World__MultiChange__data:
    Types1._World__MultiChange__data => _World__MultiChange__data =
    _input_data => migrate_Change____data(_input_data)
  and migrate_World__MultiChange__fullChange:
    Types1._World__MultiChange__fullChange => _World__MultiChange__fullChange =
    _input_data =>
      migrate_Sync____change(
        arg => migrate_World__MultiChange__selection(arg),
        arg => migrate_World__MultiChange__rebaseItem(arg),
  ...
  and migrate_World__MultiChange__rebaseItem:
    Types1._World__MultiChange__rebaseItem => _World__MultiChange__rebaseItem =
    _input_data => _input_data
  and migrate_World__MultiChange__selection:
    Types1._World__MultiChange__selection => _World__MultiChange__selection =
    _input_data => _input_data;
};
...
module Version1 = {
  ...
  and deserialize_Belt_SetString____t:
    target => Belt.Result.t(_Belt_SetString__t, list(string)) = TransformHelpers.deserialize_Belt_SetString____t
  and deserialize_Change____change:
    target => Belt.Result.t(_Change__change, list(string)) =
    constructor =>
      ...
      | JSONArray([|tag, arg0, arg1, arg2, arg3, arg4|])
        ...
        | Belt.Result.Ok(arg4) =>
          ...
          | Belt.Result.Ok(arg3) =>
            ...
            | Error(error) =>
              Belt.Result.Error(["constructor argument 2", ...error])
            }
          | Error(error) =>
            Belt.Result.Error(["constructor argument 3", ...error])
          }
        | Error(error) =>
          Belt.Result.Error(["constructor argument 4", ...error])
        }
  ...
  and deserialize_Change____data:
    target => Belt.Result.t(_Change__data, list(string)) =
    value =>
      (
  ...
  and deserialize_Change____rebaseItem:
    target => Belt.Result.t(_Change__rebaseItem, list(string)) =
    constructor =>
      switch (Js.Json.classify(constructor)) {
      | JSONArray([|tag|])
  ...
  and deserialize_Data____date:
    target => Belt.Result.t(_Data__date, list(string)) =
    value =>
      (
        number =>
          switch (Js.Json.classify(number)) {
  ...
  and deserialize_Data____source:
    target => Belt.Result.t(_Data__source, list(string)) =
    constructor =>
      switch (Js.Json.classify(constructor)) {
      | JSONArray([|tag, arg0|])
  ...
  and deserialize_Data____user:
    target => Belt.Result.t(_Data__user, list(string)) =
    record =>
      switch (Js.Json.classify(record)) {
      | JSONObject(dict) =>
  ...
  and deserialize_Data__Node__id:
    target => Belt.Result.t(_Data__Node__id, list(string)) =
    value =>
      (
        string =>
          switch (Js.Json.classify(string)) {
  ...
  and deserialize_Data__Tag__id:
    target => Belt.Result.t(_Data__Tag__id, list(string)) =
    value =>
      (
        string =>
          switch (Js.Json.classify(string)) {
  ...
  and deserialize_Data__Tag__t:
    target => Belt.Result.t(_Data__Tag__t, list(string)) =
    record =>
      switch (Js.Json.classify(record)) {
      | JSONObject(dict) =>
        let inner = attr_modified => {
  ...
  and deserialize_Delta____delta:
    target => Belt.Result.t(_Delta__delta, list(string)) = TransformHelpers.deserialize_Delta____delta
  and deserialize_Js_date____t:
    target => Belt.Result.t(_Js_date__t, list(string)) = TransformHelpers.deserialize_Js_date____t
  and deserialize_MetaData____remote:
    target => Belt.Result.t(_MetaData__remote, list(string)) =
    constructor =>
      switch (Js.Json.classify(constructor)) {
      | JSONArray([|tag, arg0, arg1|])
          when Js.Json.JSONString("Google") == Js.Json.classify(tag) =>
  ...
  and deserialize_MetaData____sync:
    target => Belt.Result.t(_MetaData__sync, list(string)) =
    record =>
      switch (Js.Json.classify(record)) {
      | JSONObject(dict) =>
        let inner = attr_etag => {
  ...
  and deserialize_MetaData____t:
    target => Belt.Result.t(_MetaData__t, list(string)) =
    record =>
      switch (Js.Json.classify(record)) {
      | JSONObject(dict) =>
        let inner = attr_sync => {
  ...
  and deserialize_NodeType____prefix:
    target => Belt.Result.t(_NodeType__prefix, list(string)) =
    constructor =>
      switch (Js.Json.classify(constructor)) {
      | JSONArray([|tag|])
  ...
  and deserialize_NodeType____t:
    target => Belt.Result.t(_NodeType__t, list(string)) =
    value =>
      (
        deserialize_Data__Node__t(
          deserialize_Delta____delta,
  ...
  and deserialize_Session____auth:
    target => Belt.Result.t(_Session__auth, list(string)) =
    record =>
      switch (Js.Json.classify(record)) {
      | JSONObject(dict) =>
  ...
  and deserialize_Session____google:
    target => Belt.Result.t(_Session__google, list(string)) =
    record =>
      switch (Js.Json.classify(record)) {
      | JSONObject(dict) =>
  ...
  and deserialize_StoreInOne__Server__serverFile:
    target => Belt.Result.t(_StoreInOne__Server__serverFile, list(string)) =
    record =>
      switch (Js.Json.classify(record)) {
      | JSONObject(dict) =>
        let inner = attr_data => {
          let inner = attr_history =>
            Belt.Result.Ok(
              {history: attr_history, data: attr_data}: _StoreInOne__Server__serverFile,
            );
  ...
  and deserialize_Sync____change:
    ...
    (
      target => Belt.Result.t('arg0, list(string)),
      target => Belt.Result.t('arg1, list(string)),
      target => Belt.Result.t('arg2, list(string)),
      target
    ) =>
  ...
  and deserialize_Sync____link:
    target => Belt.Result.t(_Sync__link, list(string)) =
    constructor =>
      switch (Js.Json.classify(constructor)) {
      | JSONArray([|tag, arg0|])
  ...
  and deserialize_View____cursor:
    target => Belt.Result.t(_View__cursor, list(string)) =
    record =>
      switch (Js.Json.classify(record)) {
      | JSONObject(dict) =>
        let inner = attr_node => {
  ...
  and deserialize_View____sharedViewData:
    target => Belt.Result.t(_View__sharedViewData, list(string)) =
    record =>
      switch (Js.Json.classify(record)) {
      | JSONObject(dict) =>
        let inner = attr_expanded =>
          Belt.Result.Ok({expanded: attr_expanded}: _View__sharedViewData);
  ...
  and deserialize_View__Range__range:
    target => Belt.Result.t(_View__Range__range, list(string)) = TransformHelpers.deserialize_View__Range__range
  and deserialize_WorkerProtocol____changeInner:
    target => Belt.Result.t(_WorkerProtocol__changeInner, list(string)) =
    value =>
      (
        deserialize_Sync____changeInner(
  ...
  and deserialize_WorkerProtocol____data:
    target => Belt.Result.t(_WorkerProtocol__data, list(string)) =
    value => deserialize_World__MultiChange__data(value)
  and deserialize_WorkerProtocol____message:
    target => Belt.Result.t(_WorkerProtocol__message, list(string)) =
    constructor =>
      switch (Js.Json.classify(constructor)) {
      | JSONArray([|tag, arg0, arg1, arg2|])
  ...
  and deserialize_WorkerProtocol____serverMessage:
    target => Belt.Result.t(_WorkerProtocol__serverMessage, list(string)) =
    constructor =>
      switch (Js.Json.classify(constructor)) {
      | JSONArray([|tag, arg0|])
  ...
  and deserialize_World____thisChange:
    target => Belt.Result.t(_World__thisChange, list(string)) =
    value =>
      (
  ...
  and deserialize_World__MultiChange__change:
    target => Belt.Result.t(_World__MultiChange__change, list(string)) =
    value =>
      (
        list =>
          switch (Js.Json.classify(list)) {
  ...
  and deserialize_World__MultiChange__data:
    target => Belt.Result.t(_World__MultiChange__data, list(string)) =
    value => deserialize_Change____data(value)
  and deserialize_World__MultiChange__fullChange:
    target => Belt.Result.t(_World__MultiChange__fullChange, list(string)) =
    value =>
      (
        deserialize_Sync____change(
          deserialize_World__MultiChange__change,
  ...
  and deserialize_World__MultiChange__rebaseItem:
    target => Belt.Result.t(_World__MultiChange__rebaseItem, list(string)) =
    value =>
      (
        list =>
          switch (Js.Json.classify(list)) {
  ...
  and deserialize_World__MultiChange__selection:
    target => Belt.Result.t(_World__MultiChange__selection, list(string)) =
    value =>
      (
        json =>
...
module Version2 = {
  ...
  and deserialize_Belt_SetString____t:
    target => Belt.Result.t(_Belt_SetString__t, list(string)) = Version1.deserialize_Belt_SetString____t
  and deserialize_Change____change:
    target => Belt.Result.t(_Change__change, list(string)) =
    constructor =>
      switch (Js.Json.classify(constructor)) {
  ...
  and deserialize_Change____rebaseItem:
    target => Belt.Result.t(_Change__rebaseItem, list(string)) = Version1.deserialize_Change____rebaseItem
  and deserialize_Data____data:
    'arg0 'arg1.
    (
      target => Belt.Result.t('arg0, list(string)),
  ...
  and deserialize_Data____date:
    target => Belt.Result.t(_Data__date, list(string)) = Version1.deserialize_Data____date
  and deserialize_Data____source:
    target => Belt.Result.t(_Data__source, list(string)) = Version1.deserialize_Data____source
  and deserialize_Data____user:
    target => Belt.Result.t(_Data__user, list(string)) = Version1.deserialize_Data____user
  and deserialize_Data__Node__column:
    target => Belt.Result.t(_Data__Node__column, list(string)) =
    record =>
      switch (Js.Json.classify(record)) {
      | JSONObject(dict) =>
        let inner = attr_width => {
          let inner = attr_kind => {
            let inner = attr_title =>
              Belt.Result.Ok(
                {title: attr_title, kind: attr_kind, width: attr_width}: _Data__Node__column,
              );
            switch (Js.Dict.get(dict, "title")) {
            | None => Belt.Result.Error(["No attribute 'title'"])
            | Some(json) =>
  ...
  and deserialize_Data__Node__columnKind:
    target => Belt.Result.t(_Data__Node__columnKind, list(string)) =
    constructor =>
      switch (Js.Json.classify(constructor)) {
      | JSONArray([|tag|])
  ...
  and deserialize_Data__Node__id:
    target => Belt.Result.t(_Data__Node__id, list(string)) = Version1.deserialize_Data__Node__id
  and deserialize_Data__Node__reaction:
    target => Belt.Result.t(_Data__Node__reaction, list(string)) =
    record =>
      switch (Js.Json.classify(record)) {
      | JSONObject(dict) =>
        let inner = attr_users => {
          let inner = attr_name =>
            Belt.Result.Ok(
              {name: attr_name, users: attr_users}: _Data__Node__reaction,
            );
          switch (Js.Dict.get(dict, "name")) {
          | None => Belt.Result.Error(["No attribute 'name'"])
          | Some(json) =>
  ...
  and deserialize_Data__Tag__id:
    target => Belt.Result.t(_Data__Tag__id, list(string)) = Version1.deserialize_Data__Tag__id
  and deserialize_Data__Tag__t:
    target => Belt.Result.t(_Data__Tag__t, list(string)) = Version1.deserialize_Data__Tag__t
  and deserialize_Delta____delta:
    target => Belt.Result.t(_Delta__delta, list(string)) = Version1.deserialize_Delta____delta
  and deserialize_Js_date____t:
    target => Belt.Result.t(_Js_date__t, list(string)) = Version1.deserialize_Js_date____t
  and deserialize_MetaData____remote:
    target => Belt.Result.t(_MetaData__remote, list(string)) = Version1.deserialize_MetaData____remote
  and deserialize_MetaData____sync:
    target => Belt.Result.t(_MetaData__sync, list(string)) = Version1.deserialize_MetaData____sync
  and deserialize_MetaData____t:
    target => Belt.Result.t(_MetaData__t, list(string)) = Version1.deserialize_MetaData____t
  and deserialize_NodeType____prefix:
    target => Belt.Result.t(_NodeType__prefix, list(string)) = Version1.deserialize_NodeType____prefix
  and deserialize_NodeType____t:
    target => Belt.Result.t(_NodeType__t, list(string)) =
    value =>
      (
  ...
  and deserialize_Session____auth:
    target => Belt.Result.t(_Session__auth, list(string)) = Version1.deserialize_Session____auth
  and deserialize_Session____google:
    target => Belt.Result.t(_Session__google, list(string)) = Version1.deserialize_Session____google
  and deserialize_StoreInOne__Server__serverFile:
    target => Belt.Result.t(_StoreInOne__Server__serverFile, list(string)) =
    record =>
      switch (Js.Json.classify(record)) {
  ...
  and deserialize_Sync____link:
    target => Belt.Result.t(_Sync__link, list(string)) = Version1.deserialize_Sync____link
  and deserialize_Sync____sessionInfo:
    type arg0.
      (target => Belt.Result.t(arg0, list(string)), target) =>
      Belt.Result.t(_Sync__sessionInfo(arg0), list(string)) = Version1.deserialize_Sync____sessionInfo
  and deserialize_View____cursor:
    target => Belt.Result.t(_View__cursor, list(string)) = Version1.deserialize_View____cursor
  and deserialize_View____sharedViewData:
    target => Belt.Result.t(_View__sharedViewData, list(string)) = Version1.deserialize_View____sharedViewData
  and deserialize_View__Range__range:
    target => Belt.Result.t(_View__Range__range, list(string)) = Version1.deserialize_View__Range__range
  and deserialize_WorkerProtocol____changeInner:
    target => Belt.Result.t(_WorkerProtocol__changeInner, list(string)) =
    value =>
      (
  ...
  and deserialize_World__MultiChange__rebaseItem:
    target => Belt.Result.t(_World__MultiChange__rebaseItem, list(string)) = Version1.deserialize_World__MultiChange__rebaseItem
  and deserialize_World__MultiChange__selection:
    target => Belt.Result.t(_World__MultiChange__selection, list(string)) = Version1.deserialize_World__MultiChange__selection
  ...
  and serialize_Belt_SetString____t: _Belt_SetString__t => target = TransformHelpers.serialize_Belt_SetString____t
  and serialize_Change____change: _Change__change => target =
    constructor =>
      switch (constructor) {
      | [@implicit_arity] Trash(arg0, arg1) =>
        Js.Json.array([|
  ...
  and serialize_Change____data: _Change__data => target =
    value =>
      (
  ...
  and serialize_Change____rebaseItem: _Change__rebaseItem => target =
    constructor =>
      switch (constructor) {
  ...
  and serialize_Data____data:
    'arg0 'arg1.
    ('arg0 => target, 'arg1 => target, _Data__data('arg0, 'arg1)) => target
   =
    (contentsTransformer, prefixTransformer, record) =>
      Js.Json.object_(
        Js.Dict.fromArray([|
  ...
  and serialize_Data____date: _Data__date => target =
    value => Js.Json.number(value)
  and serialize_Data____source: _Data__source => target =
    constructor =>
      switch (constructor) {
      | Google(arg0) =>
        Js.Json.array([|Js.Json.string("Google"), Js.Json.string(arg0)|])
      }
  and serialize_Data____user: _Data__user => target =
    record =>
      Js.Json.object_(
        Js.Dict.fromArray([|
  ...
  and serialize_Data__Node__column: _Data__Node__column => target =
    record =>
      Js.Json.object_(
        Js.Dict.fromArray([|
  ...
  and serialize_Data__Node__columnKind: _Data__Node__columnKind => target =
    constructor =>
      switch (constructor) {
  ...
  and serialize_Data__Node__id: _Data__Node__id => target =
    value => Js.Json.string(value)
  and serialize_Data__Node__reaction: _Data__Node__reaction => target =
    record =>
      Js.Json.object_(
        Js.Dict.fromArray([|
          ("name", Js.Json.string(record.name)),
  ...
  and serialize_Data__Node__t:
    'arg0 'arg1.
    ('arg0 => target, 'arg1 => target, _Data__Node__t('arg0, 'arg1)) => target
   =
    (contentsTransformer, prefixTransformer, record) =>
      Js.Json.object_(
        Js.Dict.fromArray([|
  ...
  and serialize_Data__Tag__id: _Data__Tag__id => target =
    value => Js.Json.string(value)
  and serialize_Data__Tag__t: _Data__Tag__t => target =
    record =>
      Js.Json.object_(
        Js.Dict.fromArray([|
  ...
  and serialize_Delta____delta: _Delta__delta => target = TransformHelpers.serialize_Delta____delta
  and serialize_Js_date____t: _Js_date__t => target = TransformHelpers.serialize_Js_date____t
  and serialize_MetaData____remote: _MetaData__remote => target =
    constructor =>
      switch (constructor) {
  ...
  and serialize_MetaData____sync: _MetaData__sync => target =
    record =>
      Js.Json.object_(
        Js.Dict.fromArray([|
  ...
  and serialize_MetaData____t: _MetaData__t => target =
    record =>
      Js.Json.object_(
        Js.Dict.fromArray([|
          ("id", Js.Json.string(record.id)),
  ...
  and serialize_NodeType____prefix: _NodeType__prefix => target =
    constructor =>
      switch (constructor) {
      | Todo => Js.Json.array([|Js.Json.string("Todo")|])
      | Attribution => Js.Json.array([|Js.Json.string("Attribution")|])
      }
  and serialize_NodeType____t: _NodeType__t => target =
    value =>
      (
        serialize_Data__Node__t(
          serialize_Delta____delta,
  ...
  and serialize_Session____auth: _Session__auth => target =
    record =>
      Js.Json.object_(
        Js.Dict.fromArray([|
  ...
  and serialize_Session____google: _Session__google => target =
    record =>
      Js.Json.object_(
        Js.Dict.fromArray([|
  ...
  and serialize_StoreInOne__Server__serverFile:
    _StoreInOne__Server__serverFile => target =
    record =>
      Js.Json.object_(
        Js.Dict.fromArray([|
          (
  ...
  and serialize_Sync____changeInner:
    'arg0 'arg1.
    ('arg0 => target, 'arg1 => target, _Sync__changeInner('arg0, 'arg1)) =>
    target
   =
    (changeTransformer, selectionTransformer, record) =>
      Js.Json.object_(
  ...
  and serialize_Sync____link: _Sync__link => target =
    constructor =>
      switch (constructor) {
      | Undo(arg0) =>
        Js.Json.array([|
  ...
  and serialize_Sync____sessionInfo:
    'arg0.
    ('arg0 => target, _Sync__sessionInfo('arg0)) => target
   =
    (selectionTransformer, record) =>
      Js.Json.object_(
        Js.Dict.fromArray([|
  ...
  and serialize_View____cursor: _View__cursor => target =
    record =>
      Js.Json.object_(
        Js.Dict.fromArray([|
          ("userId", Js.Json.string(record.userId)),
  ...
  and serialize_View____sharedViewData: _View__sharedViewData => target =
    record =>
      Js.Json.object_(
        Js.Dict.fromArray([|
  ...
  and serialize_View__Range__range: _View__Range__range => target = TransformHelpers.serialize_View__Range__range
  and serialize_WorkerProtocol____changeInner:
    _WorkerProtocol__changeInner => target =
    value =>
      (
        serialize_Sync____changeInner(
  ...
  and serialize_WorkerProtocol____data: _WorkerProtocol__data => target =
    value => serialize_World__MultiChange__data(value)
  and serialize_WorkerProtocol____message: _WorkerProtocol__message => target =
    constructor =>
      switch (constructor) {
      | [@implicit_arity] Init(arg0, arg1, arg2) =>
        Js.Json.array([|
  ...
  and serialize_WorkerProtocol____serverMessage:
    _WorkerProtocol__serverMessage => target =
    constructor =>
      switch (constructor) {
      | UserChange(arg0) =>
        Js.Json.array([|
  ...
  and serialize_World____thisChange: _World__thisChange => target =
    value =>
      (
  ...
  and serialize_World__MultiChange__change:
    _World__MultiChange__change => target =
    value =>
      (
        list =>
          Js.Json.array(
  ...
  and serialize_World__MultiChange__data: _World__MultiChange__data => target =
    value => serialize_Change____data(value)
  and serialize_World__MultiChange__fullChange:
    _World__MultiChange__fullChange => target =
    value =>
      (
        serialize_Sync____change(
          serialize_World__MultiChange__change,
  ...
  and serialize_World__MultiChange__rebaseItem:
    _World__MultiChange__rebaseItem => target =
    value =>
      (
        list =>
          Js.Json.array(
  ...
  and serialize_World__MultiChange__selection:
    _World__MultiChange__selection => target =
    value =>
      (
        ((arg0, arg1, arg2)) =>
          Js.Json.array([|
...
and deserializeMessage = data =>
  ...
  | [@implicit_arity] Ok(version, data) =>
    ...
    | 1 =>
      ...
      | Belt.Result.Error(error) => Belt.Result.Error(error)
      | Ok(data) =>
        let data = Types2.migrate_WorkerProtocol____message(data);
        Belt.Result.Ok(data);
      }
    | _ =>
...
and deserializeServerMessage = data =>
  ...
  | [@implicit_arity] Ok(version, data) =>
    ...
    | 1 =>
      ...
      | Belt.Result.Error(error) => Belt.Result.Error(error)
      | Ok(data) =>
        let data = Types2.migrate_WorkerProtocol____serverMessage(data);
        Belt.Result.Ok(data);
      }
    | _ =>
      Belt.Result.Error(["Unexpected version " ++ string_of_int(version)])
...
and deserializeMetaData = data =>
  ...
  | [@implicit_arity] Ok(version, data) =>
    ...
    | 1 =>
      ...
      | Belt.Result.Error(error) => Belt.Result.Error(error)
      | Ok(data) =>
        let data = Types2.migrate_MetaData____t(data);
        Belt.Result.Ok(data);
      }
    | _ =>
      Belt.Result.Error(["Unexpected version " ++ string_of_int(version)])
...
and deserializeServerFile = data =>
  ...
  | [@implicit_arity] Ok(version, data) =>
    ...
    | 1 =>
      ...
      | Belt.Result.Error(error) => Belt.Result.Error(error)
      | Ok(data) =>
        let data = Types2.migrate_StoreInOne__Server__serverFile(data);
        Belt.Result.Ok(data);
      }
    | _ =>
      Belt.Result.Error(["Unexpected version " ++ string_of_int(version)])
...
and deserializeSharedViewData = data =>
  ...
  | [@implicit_arity] Ok(version, data) =>
    ...
    | 1 =>
      ...
      | Belt.Result.Error(error) => Belt.Result.Error(error)
      | Ok(data) =>
        let data = Types2.migrate_View____sharedViewData(data);
        Belt.Result.Ok(data);
      }
    | _ =>
      Belt.Result.Error(["Unexpected version " ++ string_of_int(version)])
...
and deserializeRebaseItem = data =>
  ...
  | [@implicit_arity] Ok(version, data) =>
    ...
    | 1 =>
      ...
      | Belt.Result.Error(error) => Belt.Result.Error(error)
      | Ok(data) =>
        let data = Types2.migrate_World__MultiChange__rebaseItem(data);
        Belt.Result.Ok(data);
      }
    | _ =>
      Belt.Result.Error(["Unexpected version " ++ string_of_int(version)])
...
and deserializeChange = data =>
  ...
  | [@implicit_arity] Ok(version, data) =>
    ...
    | 1 =>
      ...
      | Belt.Result.Error(error) => Belt.Result.Error(error)
      | Ok(data) =>
        let data = Types2.migrate_World__MultiChange__change(data);
        Belt.Result.Ok(data);
      }
    | _ =>
      Belt.Result.Error(["Unexpected version " ++ string_of_int(version)])
...
and deserializeHistoryItem = data =>
  ...
  | [@implicit_arity] Ok(version, data) =>
    ...
    | 1 =>
      ...
      | Belt.Result.Error(error) => Belt.Result.Error(error)
      | Ok(data) =>
        let data = Types2.migrate_World__MultiChange__fullChange(data);
        Belt.Result.Ok(data);
      }
    | _ =>
      Belt.Result.Error(["Unexpected version " ++ string_of_int(version)])
...
and deserializeAuth = data =>
  ...
  | [@implicit_arity] Ok(version, data) =>
    ...
    | 1 =>
      ...
      | Belt.Result.Error(error) => Belt.Result.Error(error)
      | Ok(data) =>
        let data = Types2.migrate_Session____auth(data);
        Belt.Result.Ok(data);
      }
    | _ =>
      Belt.Result.Error(["Unexpected version " ++ string_of_int(version)])
...
and deserializeNode = data =>
  ...
  | [@implicit_arity] Ok(version, data) =>
    ...
    | 1 =>
      ...
      | Belt.Result.Error(error) => Belt.Result.Error(error)
      | Ok(data) =>
        let data = Types2.migrate_NodeType____t(data);
        Belt.Result.Ok(data);
      }
    | _ =>
      Belt.Result.Error(["Unexpected version " ++ string_of_int(version)])
...
and deserializeTag = data =>
  ...
  | [@implicit_arity] Ok(version, data) =>
    ...
    | 1 =>
      ...
      | Belt.Result.Error(error) => Belt.Result.Error(error)
      | Ok(data) =>
        let data = Types2.migrate_Data__Tag__t(data);
        Belt.Result.Ok(data);
      }
    | _ =>
      Belt.Result.Error(["Unexpected version " ++ string_of_int(version)])
...
and deserializeUser = data =>
  ...
  | [@implicit_arity] Ok(version, data) =>
    ...
    | 1 =>
      ...
      | Belt.Result.Error(error) => Belt.Result.Error(error)
      | Ok(data) =>
        let data = Types2.migrate_Data____user(data);
        Belt.Result.Ok(data);
      }
    | _ =>
      Belt.Result.Error(["Unexpected version " ++ string_of_int(version)])
...
module Modules = {
  module Message = {
    type t = Types2._WorkerProtocol__message;
    let serialize = serializeMessage;
    let deserialize = deserializeMessage;
  };
  module ServerMessage = {
    type t = Types2._WorkerProtocol__serverMessage;
    let serialize = serializeServerMessage;
    let deserialize = deserializeServerMessage;
  };
  module MetaData = {
    type t = Types2._MetaData__t;
    let serialize = serializeMetaData;
    let deserialize = deserializeMetaData;
  };
  module ServerFile = {
    type t = Types2._StoreInOne__Server__serverFile;
    let serialize = serializeServerFile;
    let deserialize = deserializeServerFile;
  };
  module SharedViewData = {
    type t = Types2._View__sharedViewData;
    let serialize = serializeSharedViewData;
    let deserialize = deserializeSharedViewData;
  };
  module RebaseItem = {
    type t = Types2._World__MultiChange__rebaseItem;
    let serialize = serializeRebaseItem;
    let deserialize = deserializeRebaseItem;
  };
  module Change = {
    type t = Types2._World__MultiChange__change;
    let serialize = serializeChange;
    let deserialize = deserializeChange;
  };
  module HistoryItem = {
    type t = Types2._World__MultiChange__fullChange;
    let serialize = serializeHistoryItem;
    let deserialize = deserializeHistoryItem;
  };
  module Auth = {
    type t = Types2._Session__auth;
    let serialize = serializeAuth;
    let deserialize = deserializeAuth;
  };
  module Node = {
    type t = Types2._NodeType__t;
    let serialize = serializeNode;
    let deserialize = deserializeNode;
  };
  module Tag = {
    type t = Types2._Data__Tag__t;
    let serialize = serializeTag;
    let deserialize = deserializeTag;
  };
  module User = {
    type t = Types2._Data__user;
    let serialize = serializeUser;
    let deserialize = deserializeUser;
  };
};
